...
def ManyIons_2D_fig_hist2d(X,Y,zlim,binss):
    ...
    fig.savefig(os.path.join('./', "Distribution_hist2d_%2d-%2dns.png"%(min(xxx),max(xxx))), dpi=600, bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    path          = './'
    find_ion_file = 'h3o_o_xyz_dump1_cut1.2_slab_4k_0-25ns.txt'
    ...
    if ion_num == 1:
        ...
        ManyIons_2D_fig_hist2d(T,Z,zlim,binss)
    else: # ion_num > 1
